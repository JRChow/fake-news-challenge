...
if __name__ == '__main__':
    open_process_rewrite('fnc-1/test_bodies.csv')
    open_process_rewrite('fnc-1/test_stances_unlabeled.csv')
    open_process_rewrite('fnc-1/train_bodies.csv')
    open_process_rewrite('fnc-1/train_stances.csv')
