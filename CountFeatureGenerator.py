    ...
    def process(self, df, header='train'):
        ...
        for feat_name in feat_names:
            for gram in grams:
                ...
                df["ratio_of_unique_%s_%s" % (feat_name, gram)] = \
                    map(self.try_divide, df["count_of_unique_%s_%s"%(feat_name,gram)], df["count_of_%s_%s"%(feat_name,gram)])
        ...
        for gram in grams:
            ...
            df["ratio_of_Headline_%s_in_articleBody" % gram] = \
                map(self.try_divide, df["count_of_Headline_%s_in_articleBody" % gram], df["count_of_Headline_%s" % gram])
